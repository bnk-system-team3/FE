            ...
            <li>
              ...
              <section className="studyItem_info__OFIQU">
                ...
                <div className="studyItem_viewsAndComment__1Bxpj">
                  ...
                  <div className="studyItem_infoItem__3vxSf">
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" color="#999999" height="18" width="18" xmlns="http://www.w3.org/2000/svg" style={{ color: "rgb(153, 153, 153)" }}>
