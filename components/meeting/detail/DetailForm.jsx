    ...
    <div>
      <div className="studyContent_wrapper__VVyNH">
          ...
          <section className="studyInfo_allWrapper__2ab9e">
              ...
              <li className="studyInfo_contentWrapper__KkSUP">
                ...
                <div className="contactPoint_contactWrapper__2T_GC">
                  <a className="contactPoint_link__2MqRR" href="https://open.kakao.com/o/sA2VPRie" target="_blank" rel="noreferrer">
                    <span>오픈톡</span>
                    <img className="contactPoint_linkImg__2_927" src="/images/info/link.svg" alt="링크" />
                  </a>
                </div>
              </li>
              <li className="studyInfo_contentWrapper__KkSUP">
            ...
            <div className="studyInfo_remains__1QGLr">
              ...
              <li className="studyInfo_contentWrapper__KkSUP studyInfo_oneLineItem__3-9Q7">
                ...
                <ul className="studyInfo_languageList__1usTa">
                  <li className="studyInfo_language__3A3Vi">
                    <img className="studyInfo_languageImage__2b-u9" src="/images/languages/react.svg" alt="language" />
                  </li>
                  <li className="studyInfo_language__3A3Vi">
                    <img className="studyInfo_languageImage__2b-u9" src="/images/languages/javascript.svg" alt="language" />
                  </li>
                  <li className="studyInfo_language__3A3Vi">
                    <img className="studyInfo_languageImage__2b-u9" src="/images/languages/reactnative.svg" alt="language" />
                  </li>
                </ul>
              </li>
            </div>
        ...
        <div className="studyContent_postContentWrapper__187Zh">
          <h2 className="studyContent_postInfo__3zpYu">프로젝트 소개</h2>
        ...
        <section className="sc-hHEiqL ccTnQh"><div className="sc-kfYoZR lpaEYv"><img src="/images/eye.png" alt="views" className="sc-bCwfaz hzzSzX" /><span className="sc-iwajpm kydRHc">66</span></div><div className="sc-dlMDgC kpPvTx"><img src="/images/bookmark.svg" alt="likes" className="sc-fKgJPI cxbltl" /><span className="sc-iwajpm kydRHc">2</span></div>
        </section>
        <div style={{ paddingBottom: '80px' }}><div className="commentInput_commentInput__39H41"><div className="commentInput_comment__Retbz">댓글 <span className="commentInput_commentCount__2dHvH">0</span></div><div className="commentInput_inputContainer__2W4WS"><img className="commentInput_profile__26AuB" src="https://hola-post-image.s3.ap-northeast-2.amazonaws.com/default.PNG" alt="profile" /><textarea className="commentInput_commentText__2er8t" placeholder="댓글을 입력하세요."></textarea></div><div className="commentInput_buttonWrapper__2f_l9"><button className="commentInput_buttonComplete__24z4R" name="register">댓글 등록</button></div></div><ul className="commentList_CommentList__30HUh"></ul></div></div>
    </div>
  )
}
