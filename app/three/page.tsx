...
import ApplyBtn from '@/components/meeting/detail/ApplyBtn.jsx'
        ...
        <div>
            <div className="studyContent_wrapper__VVyNH">
                <section className="studyContent_postHeader__2Qu_y">
                    ...
                    <div className="studyContent_title__3680o">비대면 진료 앱 개발 프로젝트 팀원 모집합니다.</div>
                    ...
                    <section className="studyInfo_allWrapper__2ab9e">
                        <ul className="studyInfo_studyGrid__38Lfj">
                            ...
                            <li className="studyInfo_contentWrapper__KkSUP">
                                ...
                                <span className="studyInfo_content__eqtqC">2024.01.04</span>
                            </li>
                            <li className="studyInfo_contentWrapper__KkSUP">
                        ...
                        <div className="studyInfo_remains__1QGLr">
                            <li className="studyInfo_contentWrapper__KkSUP studyInfo_oneLineItem__3-9Q7">
                                ...
                                <ul className="studyInfo_languageList__1usTa">
                                    <li className="studyInfo_positions__3JIxy">디자이너</li>
                                </ul>
                            </li>
                            <li className="studyInfo_contentWrapper__KkSUP studyInfo_oneLineItem__3-9Q7">
                                <span className="studyInfo_title__3jXRE">사용 언어</span>
                                <ul className="studyInfo_languageList__1usTa">
                                    <li className="studyInfo_positions__3JIxy">Figma</li>
                                </ul>
                            </li>
                        </div>
                    </section>
                    ...
                    <div className="studyContent_postContent__2c-FO">
                        <div className="sc-ksluID kFmqyc">
                            <div className="sc-ksluID kFmqyc">
                                ...
                                <p>&lt;담당 업무&gt;</p>
                                <p>우주닥 병원예약 플랫폼 프로덕트 디자인 총괄 (UX/UI 디자인, 기획명세서, 개발 설계서 작성)</p>
                                <p>개발 디자인 체계와 문화 구축</p>
                                <p>앱 디자인, 유지 보수</p>
                                <p>
                                    <br />
                                </p>
                                <p>&lt;이런 분을 모십니다&gt;</p>
                                <p>스킬: Figma, Illustrator, Adobe XD, Photoshop, UI, UX</p>
                ...
                <section className="sc-hHEiqL ccTnQh">
                    <div className="sc-kfYoZR lpaEYv">
                        ...
                        <span className="sc-iwajpm kydRHc">0</span>
                    </div>
